...
<div id="tooplate_body_wrapper">
        ...
        <div id="tooplate_header">
            ...
            <div id="tooplate_menu">
                <ul>
                    ...
                    <li><a href="samples/ch6.html">View Status of Bank Income</a></li>
                    <li><a href="samples/ch5.html">Bank Income</a></li>
   ...
   <%
try{  
	String a="loan_approval_verified";
	//String a="siva";
   ...
   <td><table>
       <tr><td>permanent_address</td><td><%=permanent_address%></td></tr>
                                                  <tr><td>permanent_phone</td><td><%=permanent_phone%></td></tr>
                                                    <tr><td>permanent_redidence</td><td><%=permanent_redidence%></td></tr>
                                                      <tr><td>permanent_email</td><td><%=permanent_email%></td></tr>
                                                        <tr><td>vehicle</td><td><%=vehicle%></td></tr>
                                                          <tr><td>vehicle_ownership</td><td><%=vehicle_ownership%></td></tr>
                                                            <tr><td>work_from</td><td><%=work_from%></td></tr>
                                                            
                                                            </table></td>
                                                            <td><table>
                                                          
                                                          <tr><td>Existing Loan Details</td></tr>
                                            ...
                                            <td><table><tr><td>Qualification Details
                                              <tr><td>professional</td><td><%=professional%></td></tr>
                                               <tr><td>qualification</td><td><%=qualification%></td></tr>
                                                <tr><td>educational_instituate_name</td><td><%=educational_instituate_name%></td></tr>
                                                 <tr><td>year_passing</td><td><%=year_passing%></td></tr>
                                                </td></tr></table></td>
                                                
                                                <td><table><tr><td>Reference Details</td></tr>
                                                
                                                <tr><td>reference_name1</td><td><%=reference_name1%></td></tr>
                                                <tr><td>reference_telephone1</td><td><%=reference_telephone1%></td></tr>
                                                 <tr><td>reference_relationship1</td><td><%=reference_relationship1%></td></tr>
                                                  <tr><td>reference_name2</td><td><%=reference_name2%></td></tr>
                                                  <tr><td>reference_telephone2</td><td><%=reference_telephone2%></td></tr>
                                                   <tr><td>reference_relationship2</td><td><%=reference_relationship2%></td></tr>
                                                 </table></td>
                                                 
                                                  <tr><td>declation_name</td><td><%=declation_name%></td></tr>
                                                  <%-- <tr><td><img src="<%=photo_name%>" width="124" height="98"/> </td></tr> --%>
                                            <tr><td><img src="gallery/<%=object.get("photo")%>" width="150px" height="150px"></img> </td></tr>
                                         
                                                                         
                                             <tr><td><a href="manager1.jsp?loan_no=<%=refno%>">Verify</a></td></tr> 
