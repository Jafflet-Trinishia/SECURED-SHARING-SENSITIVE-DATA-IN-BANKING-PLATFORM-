...
<div id="tooplate_body_wrapper">
    <div id="tooplate_wrapper">
        ...
        <div class="CSSTableGenerator">
		  ...
		  <tr><td><img src="images/user.png" width="501" height="412"></td>
		  
		  <td>
		  <form action="u1.jsp" methog="get">
		  <table width="352" height="189"><tr><td>Authenticator Name</td>
		  ...
		  <tr><td colspan="2" align="center"><a href="signup.jsp"><b>New User SignUp</b></a></td></tr>
		  </table></form></div>
