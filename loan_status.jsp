        ...
        /*
           ...
           // out.println(object.get("Firstname") + " " + object.get("Lastname") + "<br/>");
            %>
             <div class="CSSTableGenerator">
          <table width="400">
        <tr><td>Loan Approval Status</td></tr>
        <tr>
        <td><img src="images/loan_approved.jpg"></img></td>
        
        
        <td>The Loan Will Be Provided the Perticular Customer.</td></tr>                              
