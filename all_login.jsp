...
<div id="tooplate_body_wrapper">
    <div id="tooplate_wrapper">
        ...
        <div class="CSSTableGenerator">
		  ...
		  <tr><td colspan="2" align="center">Bank Officers Authentication Page</td></tr>
		  <tr><td><img src="images/staff.jpg" width="501" height="412"></td>
		  
		  <td>
		  <form action="all_login1.jsp" methog="get">
